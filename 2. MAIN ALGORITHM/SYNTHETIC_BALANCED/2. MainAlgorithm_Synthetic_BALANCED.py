...
best_thresholds_df = pd.DataFrame(columns=['Method', 'Metric', 'Best Value', 'Best Threshold', 'Accuracy', 'Precision', 'Recall', 'F1 Score'])
...
for method in methods:
    ...
    # Append best thresholds to best_thresholds_df
    for metric in best_thresholds.keys():
        best_value, best_thresh = best_thresholds[metric]
        best_metrics = metrics_df.loc[metrics_df['Threshold'] == best_thresh].iloc[0]
